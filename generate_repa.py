...
from models.sampler_repa import euler_maruyama_sampler, euler_sampler
...
def main(args):
    ...
    latents_channels = vae.config.latent_channels
    ...
    for _ in pbar:
        ...
        with torch.no_grad():
            ...
            latents_scale = torch.tensor(
                [scale] * latents_channels
                ).view(1, latents_channels, 1, 1).to(device)
