...
from models.models import EDiT_models
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--model", type=str, choices=list(EDiT_models.keys()), default="EDiT-XL/2")
    parser.add_argument("--image_size", type=int, choices=[256, 512], default=256)
    parser.add_argument("--num_classes", type=int, default=1000)
    parser.add_argument("--epochs", type=int, default=1400)
    parser.add_argument("--batch_size", type=int, default=1)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--vae", type=str, default="sdxl-vae")
    parser.add_argument("--text_encoder", type=str, default="clip-vit-large-patch14")
